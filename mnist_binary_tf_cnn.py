...
train_lbl_1hot, test_lbl_1hot = train_lbl_1hot[:,[d0,d1]], test_lbl_1hot[:,[d0,d1]]
...
validation_img = np.expand_dims(validation_img, axis = 3)
...
for i, size in enumerate(size_list):
    accu_test_data[i] = train_CNN(x,size,img_size, train_img,train_lbl_1hot,test_img,test_lbl_1hot)
    
outfile = 'MNIST_result/MNIST_binary_CNN_2_3_data_accu'
...
mask_size_list = np.arange(2,8,1)
...
outfile = 'MNIST_result/MNIST_binary_CNN_2_3_pm1_accu'
